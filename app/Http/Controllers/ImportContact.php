    ...
    public function jsonImportContact(Request $request) {
        if($request->ajax()){
            ...
            $contact = Contacts::create([
                ...
                'state_of_origin'   => trim($request['state_of_origin']),
                'sex'               => trim($request['sex']),
                'rank'              => trim($request['function']),
                'current_city'      => trim($request['current_city']),
                'current_state'     => trim($request['current_state']),
                'email_1'           => trim($request['email_1']),
                'email_2'           => trim($request['email_2']),
                'telephone_1'       => trim($request['phone_1']),
                'telephone_2'       => trim($request['phone_2']),
                'periodicity'       => trim($request['periodicity']),
            ]);
