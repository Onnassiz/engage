...
@section('content')
    ...
    <div class="container page-body">
        <div class="row">
            <h2 class="body-h2">Edit contact</h2>
            <h3 style="margin-top: 10px;margin-bottom: 40px" class="body-h3">Edit the info of a stakeholder or influencer</h3>
            @if (count($errors) > 0)
            ...
            {!! Form::open(['url' => '/contacts/edit/'.$contact->key, 'class' => 'form-inline']) !!}
            ...
            <div class="col-lg-8 contact-form">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('firstName')? 'has-error' : '' }}">
                        {!! Form::text('firstName', $contact->firstname, ['class' => 'form-control', 'placeholder' => 'First name']) !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div style="padding-top: 35px">
                        <label class="radio-inline">
                            <input <?php if($contact->sex == 'male') echo 'checked'?> type="radio" name="sex" value="male"> Male
                        </label>
                        <label class="radio-inline">
                            <input <?php if($contact->sex == 'female') echo 'checked'?> type="radio" name="sex" value="female"> Female
                        </label><br>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('organization')? 'has-error' : '' }}">
                        {!! Form::text('organization', \App\Organization::find(\App\ContactOrganization::whereContactId($contact->id)->first()->organization_id)->organization, ['id' => 'org', 'class' => 'form-control', 'placeholder' => 'Add or find organization'])  !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('function')? 'has-error' : '' }}">
                        {!! Form::text('function', $contact->rank, ['class' => 'form-control', 'placeholder' => 'Specify function or rank'])  !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('current_city')? 'has-error' : '' }}">
                        {!! Form::text('current_city', $contact->current_city, ['class' => 'form-control', 'placeholder' => 'Current City'])  !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('email_1')? 'has-error' : '' }}">
                        {!! Form::text('email_1', $contact->email_1, ['class' => 'form-control', 'placeholder' => 'Email'])  !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('email_2')? 'has-error' : '' }}">
                        {!! Form::text('email_2', $contact->email_2, ['class' => 'form-control', 'placeholder' => 'Second email (optional)'])  !!}
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('phone_1')? 'has-error' : '' }}">
                        {!! Form::text('phone_1', $contact->telephone_1, ['class' => 'form-control', 'placeholder' => 'Telephone'])  !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Phone_2 Form Input -->
                    <div class="form-group {{ $errors->has('phone_2')? 'has-error' : '' }}">
                        {!! Form::text('phone_2', $contact->telephone_2, ['class' => 'form-control', 'placeholder' => 'Telephone 2 (optional)'])  !!}
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="checkbox">
                    <label>
                        <input <?php if(in_array('Web',$media)){ echo 'checked'; }?> type="checkbox" value="Web" name="media[0]"> Web
                    </label><br>
                    <label>
                        <input <?php if(in_array('Tv',$media)){ echo 'checked'; }?> type="checkbox" value="Tv" name="media[1]"> Tv
                    </label><br>
                    <label>
                        <input <?php if(in_array('Radio',$media)){ echo 'checked'; }?> type="checkbox" value="Radio" name="media[2]"> Radio
                    </label><br>
                    <label>
                        <input <?php if(in_array('Print',$media)){ echo 'checked'; }?> type="checkbox" value="Print" name="media[3]"> Print
                    </label><br>
                    <label>
                        <input <?php if(in_array('Blog',$media)){ echo 'checked'; }?> type="checkbox" value="Blog" name="media[4]"> Blog
                    </label><br>
                </div>
            </div>
            <br style="clear: both">
