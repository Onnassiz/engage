    ...
    <div class="color-overlay">
        ...
        <div class="intro-header" style="padding-top: 91px">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="col-md-3">
                            <div class="login-form" style="padding-bottom: 31%">
                                <div class="">
                                    <span style="color: #110805; font-size: 22px">Sign in</span>
                                    <span style="color:  #110805" class="pull-right">or <a href="{{ "/register" }}" id="signUp" style="color: #00CAFB">Create an account</a></span>
                                </div>
                                {!! Form::open(['url' => '']) !!}
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <div>
                                            <input type="checkbox" checked name="remember" id="remember" style="left: 20px;">
                                            <label for="remember" style="color: #110805; font-size: 15px;">Remember me</label>
                                            <span class="pull-right"><a href="{{ 'password/reset' }}" style="color: #00CAFB" id="signUp">Forgot your password?</a></span>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    {!! Form::submit('Sign in', ['class' => 'btn btn-block btn-default']) !!}
                                </div>
                                {!! Form::close() !!}
