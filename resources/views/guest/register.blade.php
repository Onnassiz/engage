                ...
                <div class="col-lg-12">
                    <div class="col-md-3">
                        <div class="login-form">
                            <div class="">
                                <span style="color: #110805; font-size: 22px">Sign up</span>
                                <span style="color:  #110805" class="pull-right">or <a href="/" id="createAccount">Sign in</a></span>
                                <br/><br/>
                            </div>
                            ...
                            <div class="form-group">
                                {!! Form::submit('Sign up', ['class' => 'btn btn-block btn-default pull-right']) !!}
                            </div>
                            {!! Form::close() !!}
